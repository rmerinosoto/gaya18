...
product_data_queue_line_ref = 'woo.product.data.queue.line.ept'
...
class WooProductDataQueueEpt(models.Model):
    ...
    queue_line_ids = fields.One2many(product_data_queue_line_ref, 'queue_id')
    ...
    def create_product_queue_from_webhook(self, product_data, instance, wc_api):
        ...
        product_queue_line_obj = self.env[product_data_queue_line_ref]
    ...
    def retrieve_dashboard(self, *args, **kwargs):
        ...
        return dashboard.get_data(table=product_data_queue_line_ref)
