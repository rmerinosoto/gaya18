...
stock_warehouse_ref = 'stock.warehouse'
product_pricelist_ref = 'product.pricelist'
product_product_ref = 'product.product'
webhook_ref = 'woo.webhook.ept'
payment_gateway_ref = 'woo.payment.gateway'
wc_v3 = "wc/v3"
...
class WooInstanceEpt(models.Model):
    ...
    def _get_default_warehouse(self):
        ...
        """
        stock_warehouse_obj = self.env[stock_warehouse_ref]
    ...
    def _default_stock_field(self):
        ...
        Migrated by Maulik Barad on Date 07-Oct-2021.
        """
        stock_field = self.env['ir.model.fields'].search([('model_id.model', '=', product_product_ref),
    ...
    woo_version = fields.Selection([("v3", "Below 2.6"), ("wc/v1", "2.6 To 2.9"), ("wc/v2", "3.0 To 3.4"),
                                    (wc_v3, "3.5+")], string="WooCommerce Version", default=wc_v3,
                                   help="Set the appropriate WooCommerce Version you are using currently or\nLogin "
                                        "into WooCommerce site,Go to Admin Panel >> Plugins")
    woo_pricelist_id = fields.Many2one(product_pricelist_ref, string='Pricelist')
    woo_extra_pricelist_id = fields.Many2one(product_pricelist_ref, string='Extra Pricelist')
    ...
    woo_warehouse_id = fields.Many2one(stock_warehouse_ref, string='Warehouse', check_company=True,
    ...
    shipping_product_id = fields.Many2one(product_product_ref, "Shipping", default=_default_shipping_product,
                                          ondelete="restrict")
    fee_product_id = fields.Many2one(product_product_ref, "Fees", default=_default_fee_product, ondelete="restrict")
    discount_product_id = fields.Many2one(product_product_ref, "Discount", default=_default_discount_product,
                                          ondelete="restrict")
    ...
    webhook_ids = fields.One2many(webhook_ref, "instance_id")
    ...
    woo_stock_export_warehouse_ids = fields.Many2many(stock_warehouse_ref, string='Stock Export Warehouse', required=True)
    ...
    def update_instance_data(self, domain):
        ...
        payment_gateway_obj = self.env[payment_gateway_ref]
        woo_webhook_obj = self.env[webhook_ref]
    ...
    def sync_shipping_method_payment_gateway(self):
        ...
        if self.woo_version in ["wc/v2", wc_v3]:
    ...
    def woo_create_pricelist(self):
        ...
        return self.env[product_pricelist_ref].create(vals)
    ...
    def configure_webhooks(self, topic_list):
        ...
        Migrated by Maulik Barad on Date 07-Oct-2021.
        """
        webhook_obj = self.env[webhook_ref]
