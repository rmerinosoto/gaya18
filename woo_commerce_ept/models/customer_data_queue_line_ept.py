...
common_log_line_ref = "common.log.lines.ept"
...
class WooCustomerDataQueueLineEpt(models.Model):
    ...
    common_log_lines_ids = fields.One2many(common_log_line_ref, "woo_customer_data_queue_line_id",
    ...
    def process_woo_customer_queue_lines(self):
        ...
        common_log_line_obj = self.env[common_log_line_ref]
