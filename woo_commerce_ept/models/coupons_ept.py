...
woo_template_ref = "woo.product.template.ept"
...
class WooCouponEpt(models.Model):
    ...
    product_ids = fields.Many2many(woo_template_ref, 'woo_product_tmpl_product_rel', 'product_ids',
    ...
    exclude_product_ids = fields.Many2many(woo_template_ref, 'woo_product_tmpl_exclude_product_rel',
    ...
    def check_woocommerce_response(self, response, process, instance):
        ...
        operation = "import" if process == import_coupon else "export"
    ...
    def prepare_coupon_products(self, coupon, instance):
        ...
        @author: Maulik Barad on Date 10-Nov-2020.
        """
        woo_product_template_ept_obj = self.env[woo_template_ref]
    ...
    def woo_import_all_coupons(self, wc_api, page, instance):
        ...
        result = self.check_woocommerce_response(res, import_coupon, instance)
    ...
    def sync_woo_coupons(self, instance):
        ...
        results = self.check_woocommerce_response(res, import_coupon, instance)
