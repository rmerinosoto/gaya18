...
customer_data_queue_ref = 'woo.customer.data.queue.line.ept'
...
class WooCustomerDataQueueEpt(models.Model):
    ...
    queue_line_ids = fields.One2many(customer_data_queue_ref, 'queue_id', readonly=True)
    ...
    def create_customer_data_queue_for_webhook(self, instance, customer):
        ...
        Migrated by Maulik Barad on Date 07-Oct-2021.
        """
        customer_data_queue_line_obj = self.env[customer_data_queue_ref]
    ...
    def retrieve_dashboard(self, *args, **kwargs):
        ...
        return dashboard.get_data(table=customer_data_queue_ref)
