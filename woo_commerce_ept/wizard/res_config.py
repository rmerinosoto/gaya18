...
class WooInstanceConfig(models.TransientModel):
    ...
    def woo_create_analytic_plan_account(self, woo_instance):
        ...
        if self.env.user.has_group('analytic.group_analytic_accounting') and woo_instance:
            if not woo_instance.woo_analytic_account_id:
                ...
                analytic_account_id = woo_instance.woo_analytic_account_id
...
class ResConfigSettings(models.TransientModel):
    ...
    woo_import_order_after_date = fields.Datetime(string="WooCommerce Import Order After Date",
                                                  help="Connector only imports those orders which have created "
                                                       "after a given date.")
    # Analytic
    woo_is_use_analytic_account = fields.Boolean()
    ...
    def onchange_woo_instance_id(self):
        ...
        if instance:
            ...
            self.woo_is_use_analytic_account = instance.woo_is_use_analytic_account or False
    ...
    def execute(self):
        ...
        if instance:
            ...
            values["woo_is_use_analytic_account"] = self.woo_is_use_analytic_account or False
            ...
            if not self.woo_is_use_analytic_account:
                values["woo_analytic_account_id"] = False
    ...
    def woo_save_basic_configurations(self):
        ...
        if instance:
            basic_configuration_dict = {
                ...
                'woo_is_use_analytic_account': self.woo_is_use_analytic_account or False,
    ...
    def onchange_analytic_accounting(self):
        ...
        if self.group_analytic_accounting:
            ...
            for instance in instances:
                if instance.woo_is_use_analytic_account:
